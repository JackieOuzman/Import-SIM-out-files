...
write.csv(df_for_all_data, paste0("X:/Summer_weeds/APSIM_7/NSW_sites/output_csv/", site, "_all.csv"), row.names = FALSE)
save(df_for_all_data, 
     file = paste0("X:/Summer_weeds/APSIM_7/NSW_sites/output_csv/", site, "_all",".RData")) 
