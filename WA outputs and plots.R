...
Katanning <- read.csv(paste0("X:/Summer_weeds/APSIM_7/WA_sites/output_csv/", site, "extra_Clm_step2.csv"))
Katanning <- Katanning %>% mutate(site = "Katanning")

site <- "Meckering_top_up"
Meckering <- read.csv(paste0("X:/Summer_weeds/APSIM_7/WA_sites/output_csv/", site, "extra_Clm_step2.csv"))%>% mutate(site = "Meckering")

site <- "Merredin_top_up"
Merredin <- read.csv(paste0("X:/Summer_weeds/APSIM_7/WA_sites/output_csv/", site, "extra_Clm_step2.csv"))%>% mutate(site = "Merredin")

df <- rbind(Katanning, Meckering, Merredin)
...
ggsave(
  device = "png",
  filename = "Meckering_Biomass.png",
...
ggsave(
  device = "png",
  filename = "Katanning_Biomass.png",
  path= "X:/Summer_weeds/APSIM_7/WA_sites/plots/",
  width=8.62,
  height = 6.28,
  dpi=600
