...
## import data
site <- "Katanning_reset_water_yes"
...
Katanning_all_soil_uncontrolled_weeds$soil <- factor(Katanning_all_soil_uncontrolled_weeds$soil, levels = c("PaleSand", "Loam", "ClayLoam", "Clay", "Duplex"))
...
ggsave(
       device = "png",
       filename = "Katanning_uncontrolled_biomass.png",
...
ggsave(
       device = "png",
       filename = "Katanning_uncontrolled_yield.png",
       path= "X:/Summer_weeds/APSIM_7/WA_sites/plots/",
       width=8.62,
       height = 6.28,
       dpi=600
...
ggsave(
       device = "png",
       filename = "Katanning_uncontrolled_sownNO3.png",
       path= "X:/Summer_weeds/APSIM_7/WA_sites/plots/",
       width=8.62,
       height = 6.28,
       dpi=600
...
```{r subset Katanning data 2 plots of Iitital water and yield, echo=FALSE, message=FALSE, warning=FALSE}
...
Katanning_all_soil_controlled_weeds$soil <- factor(Katanning_all_soil_controlled_weeds$soil, levels = c("PaleSand", "Loam", "ClayLoam", "Clay", "Duplex"))
...
ggplot( aes(x=as.factor(year), y = Weed_biomass, colour = as.factor(initial_water)))+
 ...
 ggsave(
       device = "png",
       filename = "Katanning_controlled_biomass.png",
       path= "X:/Summer_weeds/APSIM_7/WA_sites/plots/",
       width=8.62,
       height = 6.28,
       dpi=600
...
Katanning_all_soil_controlled_weeds %>%
  ...
  theme_bw() +
  labs(
    title = "Katanning controlled weeds",
    subtitle = "Weed type  = summer_grass, weed sow + emerged date = Feb, \nweed density = 12, weed kill = 10",
    x = "year",
...
ggsave(
       device = "png",
       filename = "Katanning_controlled_yield.png",
       path= "X:/Summer_weeds/APSIM_7/WA_sites/plots/",
       width=8.62,
       height = 6.28,
       dpi=600
...
ggsave(
       device = "png",
       filename = "Katanning_controlled_sownNO3.png",
       path= "X:/Summer_weeds/APSIM_7/WA_sites/plots/",
       width=8.62,
       height = 6.28,
       dpi=600
