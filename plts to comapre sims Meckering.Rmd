...
```{r subset Meckering data summary, message=FALSE, warning=FALSE, include=FALSE}

Meckering_all_soil_uncontrolled_weeds_summary <-
...
Meckering_all_soil_uncontrolled_weeds_summary <- ungroup(Meckering_all_soil_uncontrolled_weeds_summary)
```
# Plot

```{r subset Meckering data plots 1, echo=FALSE, message=FALSE, warning=FALSE}

Meckering_all_soil_uncontrolled_weeds_summary$soil <- factor(Meckering_all_soil_uncontrolled_weeds_summary$soil, levels = c("PaleSand", "Loam", "ClayLoam", "Clay", "Duplex"))
...
ggsave(
       device = "png",
       filename = "Meckering_uncontrolled_biomass_top_up.png",
...
ggsave(
       device = "png",
       filename = "Meckering_uncontrolled_yld_top_up.png",
       path= "X:/Summer_weeds/APSIM_7/WA_sites/plots/",
       width=8.62,
       height = 6.28,
       dpi=600
...
ggsave(
       device = "png",
       filename = "Meckering_uncontrolled_No3_top_up.png",
       path= "X:/Summer_weeds/APSIM_7/WA_sites/plots/",
       width=8.62,
       height = 6.28,
       dpi=600
...
```{r subset Meckering data subset controlled2, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r subset Meckering data summary2, message=FALSE, warning=FALSE, include=FALSE}

Meckering_all_soil_controlled_weeds_summary <-
...
Meckering_all_soil_controlled_weeds_summary <- ungroup(Meckering_all_soil_controlled_weeds_summary)
```


```{r subset Meckering data plots 2d, echo=FALSE, message=FALSE, warning=FALSE}

Meckering_all_soil_controlled_weeds_summary$soil <- factor(Meckering_all_soil_controlled_weeds_summary$soil, levels = c("PaleSand", "Loam", "ClayLoam", "Clay", "Duplex"))
...
ggsave(
       device = "png",
       filename = "Meckering_controlled_biomass_top_up.png",
       path= "X:/Summer_weeds/APSIM_7/WA_sites/plots/",
       width=8.62,
       height = 6.28,
       dpi=600
...
ggsave(
       device = "png",
       filename = "Meckering_controlled_yld_top_up.png",
       path= "X:/Summer_weeds/APSIM_7/WA_sites/plots/",
       width=8.62,
       height = 6.28,
       dpi=600
...
ggsave(
       device = "png",
       filename = "Meckering_controlled_No3_top_up.png",
       path= "X:/Summer_weeds/APSIM_7/WA_sites/plots/",
       width=8.62,
       height = 6.28,
       dpi=600
